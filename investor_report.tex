...
\begin{itemize}[label=\textbullet, leftmargin=*]
    \item \textbf{AI Integration}: Native integration with \textbf{OpenAI} enables interactive coaching, dynamic content generation, and smart recommendations.
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item \textbf{Authentication}: We utilize a custom \textit{Node.js + JWT} architecture to manage secure, stateless user sessions, ensuring data sovereignty and flexibility.
        \item \textbf{Notifications}: \textit{Firebase Cloud Messaging (FCM)} is integrated strictly for high-reliability push notifications across iOS and Android.
...
\begin{itemize}
    ...
    \item \textbf{Offline Mode}: Full offline-first synchronization layer (SQLite/Drift) for low-connectivity environments.
\end{itemize}
...
Rituals App goes beyond static logic by embedding a persona-driven AI engine directly into the user loop.
